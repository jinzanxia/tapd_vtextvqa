...
def load_video_json(
    ...
    map_inst_id=False, num_pts_cfg=25, ):
    """
    ...
    for (img_dict, anno_dict_list) in imgs_anns:
        ...
        for anno in anno_dict_list:
            ...
            if bezierpts is not None:
                ...
                u = np.linspace(0, 1, num_pts_cfg) # num_pts_cfg: 25
...
def register_vts_instances(name, metadata, json_file, image_root, num_pts_cfg=25):
    """
    """
    ...
    DatasetCatalog.register(name, lambda: load_video_json(
        ...
        map_inst_id=True, num_pts_cfg=num_pts_cfg))
...
_PREDEFINED_SPLITS = {
    ...
    "bov_train_1": ("BOVText/frame/",
        "BOVText/train_1.json"),
    "bov_train_2": ("BOVText/frame/",
        "BOVText/train_2.json"),
    "bov_train_3": ("BOVText/frame/",
        "BOVText/train_3.json"),
    "bov_train_4": ("BOVText/frame/",
        "BOVText/train_4.json"),
    "bov_train_5": ("BOVText/frame/",
        "BOVText/train_5.json"),
...
for key, (image_root, json_file) in _PREDEFINED_SPLITS.items():
    register_vts_instances(
        ...
        os.path.join("/mnt/whuscs/hhb/vts/dataset/video/", json_file) if "://" not in json_file else json_file, 
        os.path.join("/mnt/whuscs/hhb/vts/dataset/video/", image_root), num_pts_cfg=num_pts, 
    )